...
public class SecurityConfiguracao {
    ...
    public AuthenticationManager authManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.authenticationProvider(new AutenticacaoProvider(estudanteAutenticacaoService, passwordEncoder()));
    ...
    public AutenticacaoFilter jwtAuthenticationFilterBean() {
        return new AutenticacaoFilter(estudanteAutenticacaoService, jwtAuthenticationUtilBean());
    }
